...
data class SerializerArg<T>(
    ...
    class Context(val gsonContext: JsonSerializationContext) :
        JsonSerializationContext by gsonContext {
        inline fun <reified T : Any> typedSerialize(src: T) =
...
data class DeserializerArg(
    ...
    class Context(val gsonContext: JsonDeserializationContext) :
        JsonDeserializationContext by gsonContext {
        inline fun <reified T : Any> deserialize(json: JsonElement) =
    ...
    JsonDeserializer<T> { json, type, context ->
        deserializer(
            DeserializerArg(
                json,
                type,
                DeserializerArg.Context(context)
            )
        )
    }
